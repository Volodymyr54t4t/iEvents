...
async function loadGradeStats() {
    try {
        const response = await fetch(`${API_URL}/statistics/by-grade`)
        const data = await response.json()
...
async function loadTopStudents() {
    try {
        const response = await fetch(`${API_URL}/statistics/top-students?limit=8`)
        const data = await response.json()
...
async function loadCompetitionsStats() {
    try {
        const response = await fetch(`${API_URL}/statistics/competitions-detailed`)
        const data = await response.json()
      ...
      `
        ...
        const response = await fetch(`${API_URL}/statistics/competitions`)
        const data = await response.json()
...
async function loadSchoolsStats() {
    try {
        const response = await fetch(`${API_URL}/statistics/by-school`)
        const data = await response.json()
...
async function loadAverageScores() {
    try {
        const response = await fetch(`${API_URL}/statistics/average-scores`)
        const data = await response.json()
...
async function loadParticipationRate() {
    try {
        const response = await fetch(`${API_URL}/statistics/participation-rate`)
        const data = await response.json()
...
async function loadClassDetails() {
    try {
        const response = await fetch(`${API_URL}/statistics/class-details`)
        const data = await response.json()
