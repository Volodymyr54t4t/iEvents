...
async function checkPageAccess() {
  ...
  const pageAccess = {
    "index.html": ["учень", "вчитель", "методист", "адміністратор_громади", null],
    "competitions.html": ["учень", "вчитель", "методист", "адміністратор_громади"],
    "competitionsT.html": ["вчитель", "методист"],
    "profile.html": ["учень", "вчитель", "методист"],
    "profileCommunity.html": ["адміністратор_громади"],
    "admin.html": ["методист", "адміністратор_громади"],
    "results.html": ["вчитель", "методист", "адміністратор_громади"],
    "statistics.html": ["учень", "вчитель", "методист", "адміністратор_громади"],
    "predictions.html": ["учень", "вчитель", "методист", "адміністратор_громади"],
    "auth.html": [null],
    "adminCommunity.html": ["адміністратор_громади"],
  }
